...
const AdminPetugasDashboard = () => {
  ...
  const saveUser = async () => {
    try {
      ...
      setShowModal(null);
      setUserForm({ username: "", email: "", password: "", role: "user", name: "" });
      setSelectedItem(null);
      ...
      {selectedItem && selectedItem.review && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-2xl w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-slate-900">Detail Review yang Dilaporkan</h2>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Buku</label>
                    <p className="text-slate-900 font-medium">{selectedItem.book_title}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Reviewer</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Alasan Laporan</label>
                    <p className="text-slate-900">{selectedItem.report_reason}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Dilaporkan oleh</label>
