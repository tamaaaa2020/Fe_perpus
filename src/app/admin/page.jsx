...
const AdminPetugasDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setStats(dash || {});
      setLoanTrends(dash.loanTrends || []);
      setCategoryDistribution(dash.categoryDistribution || []);
      setDailyActivity(dash.dailyActivity || []);
      ...
      if (role === "admin") {
        ...
        const topBooks = await api("/admin/dashboard/top-books", { token });
        const topUsers = await api("/admin/dashboard/top-users", { token });
